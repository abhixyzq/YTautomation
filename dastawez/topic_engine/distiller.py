...
def distill_topic_context(topic_input: Any, portal_domain: str = "india.gov.in") -> Dict[str, Any]:
    ...
    # 4.5 RESULT / MARKS / SCORE CARD / ANSWER KEY (रिजल्ट / मार्क्स / स्कोर कार्ड / उत्तर कुंजी)
    elif any(k in title_lower for k in ["score card", "marks", "result", "answer key", "cut off", "परिणाम", "अंक", "उत्तर कुंजी"]):
        return {
            "category": "परीक्षा परिणाम एवं स्कोर कार्ड",
            "topic_type": "regulatory_deadline",
            "scheme_name_hi": clean_hi,
            "scheme_name_en": clean_en,
            "short_name": "स्कोर कार्ड एवं मार्क्स",
            "target_audience": "इस परीक्षा में उपस्थित हुए सभी अभ्यर्थियों और उम्मीदवारों",
            "action_phrase": "परीक्षा के आधिकारिक मार्क्स और स्कोर कार्ड जारी कर दिए गए हैं",
            "benefit_amount": "आधिकारिक स्कोर कार्ड एवं कट-ऑफ मार्क्स",
            "benefit_summary": "उम्मीदवार आधिकारिक पोर्टल पर लॉगिन करके अपना व्यक्तिगत स्कोर और श्रेणीवार कट-ऑफ अंक देख सकते हैं।",
            "what_changed": {
                "old_rule": "पूर्व में परिणाम केवल मेरिट लिस्ट PDF के रूप में आते थे, जिसमें व्यक्तिगत अंक नहीं दिखते थे।",
                "new_rule": f"अब आधिकारिक पोर्टल {portal_domain} पर लॉगिन करके उम्मीदवार अपना नॉर्मलाइज्ड स्कोर और विषयवार अंक सीधे चेक कर सकते हैं।",
                "deadline": "निर्धारित समय सीमा तक अपना स्कोर कार्ड अवश्य डाउनलोड कर लें"
            },
            "eligibility_yes": [
                "वे सभी अभ्यर्थी जो इस परीक्षा में उपस्थित हुए थे",
                "मान्य रोल नंबर और जन्म तिथि वाले उम्मीदवार"
            ],
            "eligibility_no": [
                "परीक्षा में अनुपस्थित रहे उम्मीदवार",
                "जिनका आवेदन बोर्ड द्वारा निरस्त किया गया था"
            ],
            "documents_required": [
                "परीक्षा का रोल नंबर या रजिस्ट्रेशन नंबर",
                "जन्म तिथि एवं पोर्टल लॉगिन पासवर्ड",
                "डाउनलोड किया गया स्कोर कार्ड प्रिंट"
            ],
            "application_steps": [
                {"step": 1, "title": "आधिकारिक पोर्टल खोलें", "desc": f"आधिकारिक वेबसाइट {portal_domain} पर जाएँ और 'View Score / Marks' लिंक पर क्लिक करें।"},
                {"step": 2, "title": "लॉगिन करें", "desc": "अपना रोल नंबर / रजिस्ट्रेशन नंबर और पासवर्ड दर्ज करके साइन इन करें।"},
                {"step": 3, "title": "मार्क्स व कट-ऑफ देखें", "desc": "स्क्रीन पर अपने विषयवार अंक और अपनी श्रेणी की आधिकारिक कट-ऑफ जांचें।"},
                {"step": 4, "title": "स्कोर कार्ड डाउनलोड करें", "desc": "आगे की चयन प्रक्रिया व काउंसलिंग के लिए स्कोर कार्ड का प्रिंट सुरक्षित रख लें।"}
            ],
            "official_warning": "स्कोर कार्ड डाउनलोड करने के लिए किसी भी अनाधिकृत लिंक पर अपना पासवर्ड या ओटीपी साझा न करें।",
